            ...
            <v-card-text>
              <v-form ref="formAdd">
                <v-text-field
                  ...
                  outlined
                  :rules="[v => !!v || 'ID da Companhia Aérea é obrigatório']"
                />
                <v-text-field
                  v-model="addData.modelo"
                  label="Modelo"
                  outlined
                  :rules="[v => !!v || 'Modelo é obrigatório']"
                />
                <v-text-field
                  v-model="addData.capacidade"
          ...
          <v-card flat>
            <v-card-text>
              <v-form ref="formUpdate">
                ...
                />
                <v-text-field
                  v-model="updateData.modelo"
                  label="Modelo"
                  outlined
                />
                <v-text-field
                  v-model="updateData.capacidade"
                  label="Capacidade (pessoas)"
                  outlined
                />
              </v-form>
...
export default {
  ...
  data () {
    return {
      ...
      data: [],
      header: [
        { text: 'Tripulante ID', value: 'aeronave_id' },
        { text: 'Companhia ID', value: 'companhia_id' },
        { text: 'Modelo', value: 'modelo' },
        { text: 'Capacidade (pessoas)', value: 'capacidade' }
      ]
    }
  },
  ...
  methods: {
    ...
    add () {
      ...
      if (this.$refs.formAdd.validate()) {
        ...
        this.$axios.post('/api/aeronave', data)
          .then((res) => {
    ...
    remove () {
      ...
      if (this.$refs.formRemove.validate()) {
        this.$axios.delete('/api/aeronave', {
    ...
    update () {
      ...
      if (this.$refs.formUpdate.validate()) {
        ...
        this.$axios.put('/api/aeronave', data)
          .then((res) => {
